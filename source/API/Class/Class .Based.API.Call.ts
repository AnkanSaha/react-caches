...
export class RegisterAPIBaseDomain {
   ...
   */
	async Put(Path: str, Body: any, CallHeaders?: Headers): Promise<any> {
		return PutFetch(`${this.APIBaseDomain}${Path}`, Body, CallHeaders ? CallHeaders : this.Headers);
	}
   ...
   */
	async Delete(Path: str, CallHeaders?: Headers): Promise<any> {
		return DeleteFetch(`${this.APIBaseDomain}${Path}`, CallHeaders ? CallHeaders : this.Headers);
	}
   ...
   */
	...
	async Patch(Path: str, Body: any, CallHeaders?: Headers) {
		return PatchFetch(`${this.APIBaseDomain}${Path}`, Body, CallHeaders ? CallHeaders : this.Headers);
	}
